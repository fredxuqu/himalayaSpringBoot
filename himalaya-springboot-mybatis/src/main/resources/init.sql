...
insert into `TB_TAGS` (`ID`, `TAG_NAME`, `TYPE`, `STATUS`, `RANK`, `CREATE_TIME`, `CREATE_USER`, `MODIFY_TIME`, `MODIFY_USER`) values('1171','深圳穆迪咨询有限公司','2','2','100','2017-03-11 00:00:00','admin','2017-03-11 00:00:00','admin');
insert into `TB_TAGS` (`ID`, `TAG_NAME`, `TYPE`, `STATUS`, `RANK`, `CREATE_TIME`, `CREATE_USER`, `MODIFY_TIME`, `MODIFY_USER`) values('1172','深圳市穆迪咨询有限公司','2','2','200','2017-03-11 00:00:00','admin','2017-03-11 00:00:00','admin');
insert into `TB_TAGS` (`ID`, `TAG_NAME`, `TYPE`, `STATUS`, `RANK`, `CREATE_TIME`, `CREATE_USER`, `MODIFY_TIME`, `MODIFY_USER`) values('1173','鹏城穆迪咨询有限公司','2','2','200','2017-03-11 00:00:00','admin','2017-03-11 00:00:00','admin');
insert into `TB_TAGS` (`ID`, `TAG_NAME`, `TYPE`, `STATUS`, `RANK`, `CREATE_TIME`, `CREATE_USER`, `MODIFY_TIME`, `MODIFY_USER`) values('1181','穆迪咨询有限公司长沙分公司','2','2','100','2017-03-11 00:00:00','admin','2017-03-11 00:00:00','admin');
insert into `TB_TAGS` (`ID`, `TAG_NAME`, `TYPE`, `STATUS`, `RANK`, `CREATE_TIME`, `CREATE_USER`, `MODIFY_TIME`, `MODIFY_USER`) values('1182','穆迪咨询有限公司长沙市办事处','2','2','200','2017-03-11 00:00:00','admin','2017-03-11 00:00:00','admin');
insert into `TB_TAGS` (`ID`, `TAG_NAME`, `TYPE`, `STATUS`, `RANK`, `CREATE_TIME`, `CREATE_USER`, `MODIFY_TIME`, `MODIFY_USER`) values('1183','穆迪咨询有限公司长沙市分公司','2','2','200','2017-03-11 00:00:00','admin','2017-03-11 00:00:00','admin');
